...
export interface AdminContractorsDocuments$Params {
...
export function adminContractorsDocuments(http: HttpClient, rootUrl: string, params: AdminContractorsDocuments$Params, context?: HttpContext): Observable<StrictHttpResponse<SuccessEnvelope>> {
  const rb = new RequestBuilder(rootUrl, adminContractorsDocuments.PATH, 'get');
  if (params) {
...
adminContractorsDocuments.PATH = '/contractor-compliance/admin/contractors/{phone}/documents';
