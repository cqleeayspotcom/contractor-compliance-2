...
export interface AdminContractorsMissions$Params {
...
export function adminContractorsMissions(http: HttpClient, rootUrl: string, params: AdminContractorsMissions$Params, context?: HttpContext): Observable<StrictHttpResponse<SuccessEnvelope>> {
  const rb = new RequestBuilder(rootUrl, adminContractorsMissions.PATH, 'get');
  if (params) {
...
adminContractorsMissions.PATH = '/contractor-compliance/admin/contractors/{phone}/missions';
