...
export function notificationsPreferencesGet(http: HttpClient, rootUrl: string, params?: NotificationsPreferencesGet$Params, context?: HttpContext): Observable<StrictHttpResponse<JsonObject>> {
