...
export function profileNotifications(http: HttpClient, rootUrl: string, params?: ProfileNotifications$Params, context?: HttpContext): Observable<StrictHttpResponse<JsonObject>> {
